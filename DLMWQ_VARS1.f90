...
! changed all layer array dimensions 100=>500, 1000=>2000 LAKE TAHOE
      PARAMETER (MAXOUT=10,MAXINF=100,MAXSTO=6000,MAXDIF=45)
      PARAMETER (MAXNS=10000,MAXPAR=500,MAXCHL=7)
	   PARAMETER (MAXNLAYERS=10000)   	  
...
!wef      REAL*8 PHI(MAXINF)
      ...
      REAL*8 bgnele(MAXINF,maxseg)
	   ...
	   REAL*8 FLOINF(MAXINF)
      REAL*8 TEMINF(MAXINF)
      REAL*8 SALINF(MAXINF)
      REAL*8 WQINF(MAXINF,100)
      REAL*8 CFINF(MAXINF,7)
...
!   Secchi Depth Tahoe Lake Project
      REAL*8 SD,A_Tahoe,B_Tahoe,Bsed_Tahoe,Chloro_Tahoe,Kd_Tahoe
